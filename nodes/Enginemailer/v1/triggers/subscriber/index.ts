...
export const description: INodeProperties[] = [
	{
		...
		options: [
			{
				name: 'On Autoresponder Completed',
			...
			{
				name: 'On Autoresponder Triggered',
			...
			{
				name: 'On Untagged with Subcategory',
				value: 'untagged',
